...
public class TypeGoodAttrServiceImpl implements TypeGoodAttrService {
    ...
    public TypeGoodAttrResponseDTO updateData(TypeGoodAttrRequestDTO typeGoodAttrRequestDTO) {
        TypeGoodAttr typeGoodAttr = typeGoodAttrRepository.findById(Long.valueOf(typeGoodAttrRequestDTO.getTypeGoodCode())).orElseThrow(() -> new DataNotFoundException("Khong tim thay du lieu"));
